...
Open the file and change what you want. For example, enable squash merge and add topics:
...
Plan: 0 to create, 1 to update, 0 to destroy
  ...
  ~ babarot/my-project
      ~ merge_strategy.allow_squash_merge: false => true
      ~ merge_strategy.allow_merge_commit: true => false
      + topics: [go, cli]
```
