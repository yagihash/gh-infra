...
Some repos may want to manage their own settings (see [Self-Managed Repos](../self-managed/)). Simply omit those repos from your central YAML files — gh-infra only manages what's declared.
